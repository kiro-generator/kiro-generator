...
*   [`keyboardShortcut`](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#keyboardshortcut-field) — Keyboard shortcut for quickly switching to this agent.
*   [`welcomeMessage`](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#welcomemessage-field) — Message displayed when switching to this agent.
...
### File resources[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#file-resources)
...
### Skill resources[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#skill-resources)
...
### Knowledge base resources[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#knowledge-base-resources)
...
*   `matcher` (optional): Pattern to match tool names for `preToolUse` and `postToolUse` hooks. Hook matchers use internal tool names (`fs_read`, `fs_write`, `execute_bash`, `use_aws`) rather than simplified names. See [built-in tools documentation](https://kiro.dev/docs/cli/custom-agents/configuration-reference/built-in-tools.md) for available tool names.
...
KeyboardShortcut field[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#keyboardshortcut-field)
-----------------------------------------------------------------------------------------------------------------
...
WelcomeMessage field[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#welcomemessage-field)
-------------------------------------------------------------------------------------------------------------
...
### keyboardShortcut[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#keyboardshortcut)
...
### welcomeMessage[](https://kiro.dev/docs/cli/custom-agents/configuration-reference/#welcomemessage)
