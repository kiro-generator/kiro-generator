...
- You want help designing a sane inheritance/template layout instead of freehanding TOML from scratch
...
5. Run `kg diff` before `kg generate`
...
Use the [`--skeleton` quickstart](quickstart.md) when:
