...
Share complete agent configurations (MCP servers + resources + permissions). See [VENDOR.md](https://github.com/kiro-generator/kiro-generator/blob/main/VENDOR.md) for future plans.
