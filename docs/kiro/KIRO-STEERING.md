...
URL Source: https://kiro.dev/docs/cli/steering/
Scraped: 2026-02-12T16:52:31.369Z
...
## What is steering? [Copy link to this section](https://kiro.dev/docs/cli/steering/\#what-is-steering)
...
## Key benefits [Copy link to this section](https://kiro.dev/docs/cli/steering/\#key-benefits)
...
## Steering file scope [Copy link to this section](https://kiro.dev/docs/cli/steering/\#steering-file-scope)

Steering files can be created with a workspace scope or a global scope.

### Workspace steering [Copy link to this section](https://kiro.dev/docs/cli/steering/\#workspace-steering)
...
### Global steering [Copy link to this section](https://kiro.dev/docs/cli/steering/\#global-steering)
...
### Team steering [Copy link to this section](https://kiro.dev/docs/cli/steering/\#team-steering)
...
## Foundational steering files [Copy link to this section](https://kiro.dev/docs/cli/steering/\#foundational-steering-files)
...
## Creating custom steering files [Copy link to this section](https://kiro.dev/docs/cli/steering/\#creating-custom-steering-files)
...
## Steering with custom agents [Copy link to this section](https://kiro.dev/docs/cli/steering/\#steering-with-custom-agents)

When using [custom agents](https://kiro.dev/docs/cli/custom-agents/creating), steering files are not automatically included. You must explicitly add them to the agent's `resources` configuration to load steering context.
...
This glob pattern ensures all markdown files in your steering directory are loaded when using the agent. See the [custom agents documentation](https://kiro.dev/docs/cli/custom-agents/creating/#agent-configuration-file) for a complete configuration example.

## Agents.md [Copy link to this section](https://kiro.dev/docs/cli/steering/\#agentsmd)
...
## Best practices [Copy link to this section](https://kiro.dev/docs/cli/steering/\#best-practices)
...
## Common steering file strategies [Copy link to this section](https://kiro.dev/docs/cli/steering/\#common-steering-file-strategies)
