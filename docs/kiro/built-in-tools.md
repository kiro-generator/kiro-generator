...
### Custom diff tools[](https://kiro.dev/docs/cli/reference/built-in-tools/#custom-diff-tools)
...
### Fetch modes[](https://kiro.dev/docs/cli/reference/built-in-tools/#fetch-modes)
...
### Troubleshooting[](https://kiro.dev/docs/cli/reference/built-in-tools/#troubleshooting)
...
### How it works[](https://kiro.dev/docs/cli/reference/built-in-tools/#how-it-works)
...
### What it provides[](https://kiro.dev/docs/cli/reference/built-in-tools/#what-it-provides)
...
### Example questions[](https://kiro.dev/docs/cli/reference/built-in-tools/#example-questions)
...
Enable automatic [tangent mode](https://kiro.dev/docs/cli/experimental/tangent-mode) for introspect questions to keep help conversations separate from your main work:
...
Code intelligence[](https://kiro.dev/docs/cli/reference/built-in-tools/#code-intelligence)
------------------------------------------------------------------------------------------
...
For comprehensive documentation on code intelligence features, see [Code Intelligence](https://kiro.dev/docs/cli/code-intelligence).

This tool has no configuration options.

Delegate tasks[](https://kiro.dev/docs/cli/reference/built-in-tools/#delegate-tasks)
------------------------------------------------------------------------------------
...
### Configuration[](https://kiro.dev/docs/cli/reference/built-in-tools/#configuration-2)
