...
<CardGroup cols={2}>
  <Card title="Install" icon="download" href="/content/getting-started/install">
  ...
  <Card title="Guided migration" icon="sparkles" href="/content/migration/guided-migration">
    Use SKILL `kg-helper` to inspect existing agents and migrate them into TOML.
  </Card>
</CardGroup>
